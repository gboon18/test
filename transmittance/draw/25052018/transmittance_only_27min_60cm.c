{
  ...
  for(i = 10 ; i < 50 ; i++){
	...
	//	cout<<dk_27min_60cm[j]<<endl;
      ...
      gr_27min_60cm->SetTitle((name_front + i_str).c_str());
      gr_27min_60cm->SetLineColor(2);
      gr_27min_60cm->SetMarkerColor(2);
      gr_27min_60cm->SetMarkerStyle(1);
      gr_27min_60cm->GetXaxis()->SetLimits(325, 900);
      gr_27min_60cm->GetYaxis()->SetRangeUser(0,100);
      gr_27min_60cm->GetXaxis()->SetTitle("Wavelength [nm]");
      gr_27min_60cm->GetYaxis()->SetTitle("Transmittance [%]");
      gr_27min_60cm->Draw("APL");
      mg->Draw("PL");
      ...
      TLegend *leg = new TLegend(0.4, 0.1, .9, .35);
      leg->AddEntry(gr_giessen_before, "Giessen before irr", "l");
      leg->AddEntry(gr_giessen_irr, "Giessen 30Gy(1.16Gy/min), 26min", "l");      
      leg->AddEntry(gr_before, "IPN before irr", "l");
      leg->AddEntry(gr_27min_60cm, "IPN 30Gy(1.11Gy/min), 27min", "l");
      ...
      gr_dk_giessen->SetLineColor(4);
      gr_dk_giessen->SetMarkerColor(4);
      gr_dk_giessen->SetLineStyle(1);//1=solid, 2=dash, 3=dot, 4=dash-dot
      mg_dk->Add(gr_dk_giessen);
      
      TGraph *gr_dk_27min_60cm = new TGraph(wavelength.size(), &wavelength[0], &dk_27min_60cm[0]);
      gr_dk_27min_60cm->SetTitle((name_front + i_str).c_str());
      gr_dk_27min_60cm->SetLineColor(2);
      gr_dk_27min_60cm->SetMarkerColor(2);
      gr_dk_27min_60cm->SetMarkerStyle(1);
      gr_dk_27min_60cm->GetXaxis()->SetLimits(325, 900);
            gr_dk_27min_60cm->GetYaxis()->SetRangeUser(0,4.);
      //      gr_dk_27min_60cm->GetYaxis()->SetRangeUser(0,15.);
      //      gr_dk_27min_60cm->GetYaxis()->SetRangeUser(0,1.6);
      //      gr_dk_27min_60cm->GetYaxis()->SetRangeUser(0,.8);
      gr_dk_27min_60cm->GetXaxis()->SetTitle("Wavelength [nm]");
      gr_dk_27min_60cm->GetYaxis()->SetTitle("dK [1/m]");
      gr_dk_27min_60cm->Draw("APL");
      mg_dk->Draw("PL");
      ...
      TLegend *leg = new TLegend(0.47, 0.7, .9, .9);
      leg->AddEntry(gr_dk_giessen, "Giessen 30Gy(1.16Gy/min), 26min", "l");      
      leg->AddEntry(gr_dk_27min_60cm, "IPN 30Gy(1.11Gy/min), 27min", "l");
  ...
  c1->Print("output/transmittance_with_giessen_15052018.eps");
  c2->Print("output/dk_wo_15irr_with_giessen_15052018.eps");
}
