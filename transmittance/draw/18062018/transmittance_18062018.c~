  ...
  for(i = 10 ; i < 50 ; i++){
	...
	mg->Draw("PL");
      */
      ...
      /*
	TGraph *gr_dk_30X2min_15cm_22052018 = new TGraph(wavelength.size(), &wavelength[0], &dk_30X2min_15cm_22052018[0]);
	gr_dk_30X2min_15cm_22052018->SetLineColor(2);
	gr_dk_30X2min_15cm_22052018->SetMarkerColor(2);
	gr_dk_30X2min_15cm_22052018->SetMarkerStyle(1);
	mg_dk->Add(gr_dk_30X2min_15cm_22052018);      
      
	TGraph *gr_dk_30min_15cm_22052018 = new TGraph(wavelength.size(), &wavelength[0], &dk_30min_15cm_22052018[0]);
	gr_dk_30min_15cm_22052018->SetTitle((name_front + i_str).c_str());
	gr_dk_30min_15cm_22052018->SetLineColor(4);
	gr_dk_30min_15cm_22052018->SetMarkerColor(4);
	gr_dk_30min_15cm_22052018->SetMarkerStyle(1);
	gr_dk_30min_15cm_22052018->GetXaxis()->SetLimits(325, 900);
	gr_dk_30min_15cm_22052018->GetYaxis()->SetRangeUser(0,4.);
	//      gr_dk_30min_15cm_22052018->GetYaxis()->SetRangeUser(0,15.);
	//      gr_dk_30min_15cm_22052018->GetYaxis()->SetRangeUser(0,1.6);
	//      gr_dk_30min_15cm_22052018->GetYaxis()->SetRangeUser(0,.8);                  
	gr_dk_30min_15cm_22052018->GetXaxis()->SetTitle("Wavelength [nm]");
	gr_dk_30min_15cm_22052018->GetYaxis()->SetTitle("dK [1/m]");
	gr_dk_30min_15cm_22052018->Draw("APL");
	mg_dk->Draw("PL");      
      */
      ...
      leg->AddEntry(gr_dk_130min_15cm_25052018, "130min, 15cm, not fully cured", "l");
      leg->AddEntry(gr_dk_290min_15cm_25052018, "290min, 15cm, not fully cured", "l");      
      leg->Draw();      
