{
  ...
  for(i = 10 ; i < 50 ; i++){
	...
	//	cout<<dk_27min_60cm[j]<<endl;
      ...
      */
      ...
      leg->AddEntry(gr_p_n_cured_22052018, "natural light cured", "l");
      leg->AddEntry(gr_30min_15cm_22052018, "30min irr, 15cm", "l");
      leg->AddEntry(gr_30X2min_15cm_22052018, "60min irr, 15cm", "l");            
      ...
      leg->AddEntry(gr_dk_30min_15cm_22052018, "30min, 15cm", "l");
      leg->AddEntry(gr_dk_30X2min_15cm_22052018, "60min, 15cm", "l");      
      leg->Draw();      
  ...
  //  c1->Print("output/transmittance_22052018.eps");
  //  c2->Print("output/dk_22052018.eps");
}
