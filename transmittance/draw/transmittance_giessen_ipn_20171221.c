void transmittance_giessen_ipn_20171221(){
  ...
  double wavelength_before_Tanja[/* n */23] = {0.}; //total 26 points - 1 origin - 2 x,y maximum respectively = 23 data points
  double transmittance_before_Tanja[/* n */23] = {0.};
  ...
  TGraph *gr_before_Tanja = new TGraph(/* n */23,wavelength_before_Tanja,transmittance_before_Tanja);
