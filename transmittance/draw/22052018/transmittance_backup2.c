{
  ...
  for(i = 10 ; i < 50 ; i++){
    if(i == 11 || i == 23 || i == 31 || i == 33 || i == 34 || i == 37 || i == 38 || i == 43 || i == 44) {
      ...
      string dir_partially_naturally_cured = "PbWO4_Partial_Natural_Cure_top_left_22052018/";
      ...
      string file_partially_naturally_cured = dir_22052018 + dir_partially_naturally_cured + name_front + i_str + name_back;
      ...
      vector<double> transmittance_original, transmittance_p_n_cured_22052018, transmittance_before_irr, transmittance_27min_60cm, transmittance_27X2min_60cm, transmittance_30min_15cm_03052018, transmittance_30min_15cm_22052018, transmittance_30X2min_15cm_03052018;
